...
const characters = [
    { base: 'water',          name: 'Water',        rarity: 'Rare',      themes: ['Basic', 'Gold', 'Candy', 'Galaxy', 'Holofoil'], unreleased: ['Gem'] },
    { base: 'earth',          name: 'Earth',        rarity: 'Rare',      themes: ['Basic', 'Gold', 'Candy', 'Galaxy'], unreleased: ['Gem'] },
    { base: 'fire',           name: 'Fire',         rarity: 'Rare',      themes: ['Basic', 'Gold', 'Candy', 'Galaxy', 'Holofoil'] },
    { base: 'duck',           name: 'Duck',         rarity: 'Epic',      themes: ['Basic', 'Gold', 'Candy', 'Galaxy'], unreleased: ['Gem'] },
    { base: 'ghost',          name: 'Ghost',        rarity: 'Epic',      themes: ['Basic', 'Gold', 'Candy', 'Galaxy', 'Holofoil'] },
    ...
    { base: 'king',           name: 'King',         rarity: 'Epic',      themes: ['Basic', 'Gold', 'Candy', 'Galaxy', 'Holofoil'] },
    ...
    { base: 'striker',        name: 'Striker',      rarity: 'Epic',      themes: ['Basic', 'Gold', 'Candy', 'Galaxy', 'Holofoil'] },
